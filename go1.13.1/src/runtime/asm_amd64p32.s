...
TEXT runtime·gogo(SB), NOSPLIT, $8-4
	...
	get_tls(CX)
	MOVL	DX, g(CX)  //gobuf.g = &tls
	MOVL	gobuf_sp(BX), SP	// restore SP  SP = gobuf.sp
...
TEXT runtime·mcall(SB), NOSPLIT, $0-4
	...
	MOVL	0(SP), BX	// caller's PC
	MOVL	BX, (g_sched+gobuf_pc)(AX) // 设置g2.gobuf.pc
	LEAL	fn+0(FP), BX	// caller's SP
	MOVL	BX, (g_sched+gobuf_sp)(AX) // 设置g2.gobuf.sp
	MOVL	AX, (g_sched+gobuf_g)(AX) //设置g2.gobuf.g

	// switch to m->g0 & its stack, call fn
	MOVL	g(CX), BX
	MOVL	g_m(BX), BX
	MOVL	m_g0(BX), SI  // si = g2.m.g0
	...
	MOVL	DI, DX
	MOVL	0(DI), DI
	CALL	DI // 这里调用的fn，就是goexit,它的参数是g0
	POPQ	AX
