...
// 比如class=3的size是32byte，它的每个span有1个页面，所以每个span可以切分为1*8KB/32byte=256块

// 这个是class和size的映射，下标是class，值是size，size单位是byte
// 如果要分配的对象size不等于这些，向上取
// 最大的为32768即32KB, 如果大于这个值就属于大对象了
