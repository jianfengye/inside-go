...
type EvaluableExpression struct {
	...
	*/
	...
	/*
		...
		判断当表达式里面的变量类型错误了，有什么反应，如果是true，就返回error，如果是false，就panic
	*/
	ChecksTypes bool
	
	tokens           []ExpressionToken // 表达式拆解之后的每个零件
...
/*
	...
	使用自定义函数解析表达式，其他同 NewEvaluableExpression 。
	这三个New表达式觉得并不好，有大量重复的实现内容，完全可以设计为参数可变的形式。
*/
